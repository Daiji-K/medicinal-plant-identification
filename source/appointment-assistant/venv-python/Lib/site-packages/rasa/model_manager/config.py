...
# Studio 1.x deployments set RASA_MODEL_SERVER_BASE_URL to a `/talk` path and
# expect the REST API at the root.
STUDIO_V1_PATH_PREFIX = "talk"
...
STUDIO_AUTH_URL = os.environ.get("STUDIO_AUTH_URL", None)

DEFAULT_MODEL_INACTIVE_AFTER_MS = 300_000

MODEL_INACTIVE_AFTER_MS = int(
    os.getenv(
        "MODEL_INACTIVE_AFTER_MS",
        DEFAULT_MODEL_INACTIVE_AFTER_MS,
    )
)
