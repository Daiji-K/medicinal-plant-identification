...
MINIMUM_COMPATIBLE_VERSION = "3.18.0"
...
# Langfuse logging configuration. Default ERROR so the SDK's WARNING-level noise
# (e.g. "client initialized without public_key", "no active span") is silenced when
# Langfuse is installed but not configured; overridable for debugging.
ENV_LOG_LEVEL_LANGFUSE = "LOG_LEVEL_LANGFUSE"
DEFAULT_LOG_LEVEL_LANGFUSE = "ERROR"
